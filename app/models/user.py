...
class User(Base):
    ...
    vip_expire_time = Column(DateTime, nullable=False, default="1970-01-01 00:00:00", index=True, comment="VIP到期时间")
    ...
    last_upload_date = Column(Date, nullable=False, default="1970-01-01", comment="最后上传日期")
